...
const ClientFormFields = ({
  ...
  return (
    <Grid container spacing={3}>
      ...
      {/* Consent Required Overlay - blur and disable form if consent not given */}
      <Grid item xs={12}>
        <Box
          sx={{
            position: "relative",
            ...(formData.consentV1Accepted
              ? {}
              : {
                  "&::before": {
                    content: '""',
          ...
          {!formData.consentV1Accepted && (
            ...
            >
              ...
              <Typography variant="body2" color="text.secondary">
                Please check the consent checkbox above to continue with the form.
              </Typography>
            </Box>
          )}

...
export const PJSIPEndpoint = sequelize.define(
  "ps_endpoints",
  {
    ...
    aors: {
      type: DataTypes.STRING(40),
      allowNull: true, // ✅ Allows endpoints to exist without a predefined AOR.
    },
    send_pai: PJSIP_BOOL,
    ...
    auth: PJSIP_STRING(), // The authentication ID, links to ps_auths
...
export const PJSIPContact = sequelize.define(
  "ps_contacts",
  {
    ...
    last_seen: {
      type: DataTypes.INTEGER,
      allowNull: true,
      comment: "Epoch seconds marker for last seen online/offline",
    },
  },
  {
...
PJSIPEndpoint.hasOne(PJSIPAor, {
  foreignKey: "id",
  sourceKey: "aors",
  as: "aorConfig",
});

PJSIPEndpoint.hasOne(PJSIPAuth, {
  foreignKey: "id",
  sourceKey: "auth",
  as: "authConfig",
});
...
// PJSIPEndpoint.belongsTo(PJSIPAuth, { foreignKey: "auth" });
// PJSIPEndpoint.belongsTo(PJSIPAor, { foreignKey: "aors" });
// PJSIPEndpoint.belongsTo(PJSIPTransport, { foreignKey: "transport" });
// PJSIPIdentify.belongsTo(PJSIPEndpoint, { foreignKey: "endpoint" });
// PJSIPRegistration.belongsTo(PJSIPAuth, { foreignKey: "outbound_auth" });

// Ensure Default Transports
// export async function ensureDefaultTransports() {
//   try {
//     // Ensure UDP Transport exists
//     await PJSIPTransport.upsert({
//       id: "transport-udp",
//       protocol: "udp",
//       bind: "0.0.0.0:5060",
//       external_media_address: process.env.ASTERISK_HOST,
//       external_signaling_address: process.env.ASTERISK_HOST,
//       tos: "0",
//       cos: 0,
//       allow_reload: "yes",
//     });

//     // Ensure WebSocket Transport exists
//     await PJSIPTransport.upsert({
//       id: "transport-ws",
//       protocol: "ws",
//       bind: "0.0.0.0:8088",
...
//     // Ensure TLS Transport exists (if certificates are configured)
//     if (process.env.PJSIP_TLS_CERT_FILE && process.env.PJSIP_TLS_PRIVATE_KEY) {
//       await PJSIPTransport.upsert({
//         id: "transport-tls",
//         protocol: "tls",
//         bind: "0.0.0.0:5061",
//         external_media_address: process.env.ASTERISK_HOST,
//         external_signaling_address: process.env.ASTERISK_HOST,
//         cert_file: process.env.PJSIP_TLS_CERT_FILE,
//         priv_key_file: process.env.PJSIP_TLS_PRIVATE_KEY,
//         verify_server: "no",
//         verify_client: "no",
...
//     console.log("Default PJSIP transports initialized successfully");
//   } catch (error) {
//     console.error("Error ensuring default transports:", error);
//     throw error;
//   }
// }
